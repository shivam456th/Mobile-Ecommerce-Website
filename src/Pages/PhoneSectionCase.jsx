...
const PhoneSectionCase = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await instance.get("/phonecase");
    ...
    <>
      {loading ? (
        ...
        <div className="md:px-14 px-2 py-5">
          ...
          <p className="md:text-2xl font-semibold text-center">Phone Cases</p>
...
export default PhoneSectionCase;
