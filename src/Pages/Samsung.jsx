...
const Samsung = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const samsungPhones = response.data.filter(product => product.brand === "Samsung");
      setData(samsungPhones);
    } catch (error) {
    ...
    <>
      {loading ? (
        ...
        <div className="md:px-14 px-2 py-5">
          ...
          <p className="md:text-2xl font-semibold text-center">Samsung</p>
